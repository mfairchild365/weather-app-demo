...
/**
 * Thin styled wrapper around native `<table>`/`<caption>`/`<th scope="col">` for static tabular
 * data (references/tables-grids.md) — not an interactive grid, which this project has no need
 * for.
 */
